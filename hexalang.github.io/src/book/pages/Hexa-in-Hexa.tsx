...
export const Article = () => {
	return (
		<>
			...
			<p>It is now really easy to add new targets with introduced adaptive code <Page page={Normalizer}>normalizer</Page>. It receives platform-specific keywords and rules directly, and does all renaming stuff and heavy lifting by itself.</p>
			<p></p>
